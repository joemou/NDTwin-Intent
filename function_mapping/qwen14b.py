import os
# 強制 Hugging Face Hub 進入離線模式，禁止任何連線嘗試
...
def train_fold(train_data_list, fold_idx):
    ...
    # ==========================================
    # ★ 模型合併與儲存區塊 (Model Merging)
    # ==========================================
    print(f"[Fold {fold_idx}] Merging LoRA weights and saving...")
    
    # 從日誌看到你用的是 32GB 的 RTX 5090，VRAM 應該足夠做 16-bit 合併
    model.save_pretrained_merged(f"merged_qwen14b_fold_{fold_idx}", tokenizer, save_method="merged_16bit")
